...
abstract public class NetCommonBean {
     ...
     * 那么子类要继承本类，而不是继承{@link com.android.jesse.huitao.net.bean.NetBaseBean}，
     ...
     * <p>
     * 详情请看
     * {@link com.android.jesse.huitao.net.demo.bean.NetUserBean}
     *
     *
     * 子类重写这个方法时，因为要返回，所以请将返回类型 T 改成具体类型，不然编译会报错
     * 具体使用请看以下两个类
     * {@link com.android.jesse.huitao.net.demo.bean.NetNewsBean}
     * {@link com.android.jesse.huitao.net.util.NetCommonBeanUtil}
     *
