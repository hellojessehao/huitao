...
import com.android.jesse.huitao.net.aes.AesUtil;
import com.android.jesse.huitao.net.core.common.RequestType;


/**
 * @ClassName: RequestUtil
 * @Desciption: 对Http请求进行包装，涉及到加解密以及其它内容等，都放到这个类里面处理，而不与HttpUtil耦合
 * @author: yichaohua
 * @date: 2017-12-16
 */
public class RequestUtil {
    ...
    public static String postRequest(HttpEngine httpEngine, String url, String param) throws Exception {
        ...
        Log.d(TAG, "request: " + url + " param: " + param);
     ...
     * @throws Exception e
     */
    public static String request(boolean jsonContentType, RequestType requestType, HttpEngine httpEngine, String url, String param) throws Exception {
        String ret;

        Log.d(TAG, "request: " + url + " param: " + param);
        String data = AesUtil.encryptToString(param);

        String tmp = httpEngine.request(jsonContentType,requestType,url,data);
        Log.d(TAG, "response: " + " ret: " + tmp);
