 ...
 *
 */
public class ImageViewRoundRect extends AppCompatImageView {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyle) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ImageViewRoundRect);
        mRoundRadius = SizeUtils.dp2px(ta.getInt(R.styleable.ImageViewRoundRect_roundRadius,DEFAUT_ROUND_RADIUS));
        mType = ta.getInt(R.styleable.ImageViewRoundRect_type,0);
        ta.recycle();
        mPaint = new Paint();
